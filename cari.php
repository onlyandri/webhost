...
if(isset($_POST["cari"])){
	...
	$output = '';
	$query = "SELECT * FROM musik where penyayi like '%".$_POST["cari"]."%' or judul LIKE '%".$_POST["cari"]."%' or album LIKE '%".$_POST["cari"]."%'";
	...
	if(mysqli_num_rows($result)>0){
		...
		<h3 class="font-weight-bold text-light">YOUR SEARCH</h3>
		</div>
		</div>
		</div>
		<div class="row">';
