      ...
      <div class="collapse navbar-collapse p-3" id="navbarSupportedContent">
       ...
       <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link text-light font-weight-bold mr-2" href="#">Beranda<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item active">
      ...
      <div class="row" id="lili">
        ...
        <?php while($row = mysqli_fetch_assoc($result)) : ?>
          ...
          <div class="card ml-5 mb-4" style="width: 200px; background-color: #000">
            <img src="img/<?= $row["gambar"]?>" class="card-img-top" alt="..." style="height: 150px;">
            <div class="card-body">
             ...
             <p class="card-tex text-light mt-2"><?= $row["penyayi"]?><p>
              <p class="card-text text-light mt-2">album : <?= $row["album"]?><p>
               <audio controls style="width: 150px; height: 50px;">
                <source src="audio/<?= $row["audio"]?>" type="audio/mp3">
                </audio>
                <a href="https://download-lagu-mp3.com/id/download-<?= $row["judul"]?>-<?= $row["penyayi"]?>" class="btn btn-primary" style="width: 100%"><i class="fas fa-download mr-2 text-light"></i>download</a>
              </div>
            </div>
          <?php endwhile; ?>
        </div>

        <div class="row mr-2 mb-5 bg-dark">
